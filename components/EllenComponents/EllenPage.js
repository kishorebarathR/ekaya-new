    ...
    return (
        <>
            <Container className='ms-5'>
                <p className='justify-content-center mx-4 mt-5 display-6 ms-lg-4 px-lg-5'>Truly a home for your future!</p>
                <p className=' fs-6 mx-4 mt-3 ms-lg-4 px-lg-5'>Ekaya brings you its prestigious project, ELLEN - a premium three-storey apartment block, with a total of 11 spacious modern homes, abound with new age luxuries.</p>
                <p className=' fs-6 mx-4 mt-3 ms-lg-4 px-lg-5'>Every floor houses just two, 2 bedroom and one, 3 bedroom home. Each unit has an open kitchen with a spacious utility area, an exclusive dining area, and a spacious balcony. All Vaastu-compliant homes are thoughtfully designed, keeping in mind the most primary need of the day - space and privacy. The residences are beautifully weaved into the very fiber of ELLEN’s design structure.</p>
                <p className=' fs-6 mx-4 mt-3 ms-lg-4 px-lg-5'>At ELLEN compromise was never an option. Only the best of everything has been utilized, right from the building material, to its 24 hrs - power back up,the gym, to the maneuver-friendly stilt ( ground level ) and basement parking , to the finish with marble and wooden flooring.</p>
            </Container>
            <Container>
                <Row className='d-flex flex-row ms-lg-1 px-lg-5 '>                   
                    <Col lg={8} className=''>
