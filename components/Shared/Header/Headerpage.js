...
const Headerpage = () => {
  ...
  return (
    <>
      ...
      {/* <Container fluid className="position-fixed  min-vh-100 z-3">
        <Row>
        <Col lg={1} className="border-end min-vh-100 grid-line-1"></Col>
        <Col lg={3} className="border-end min-vh-100 grid-line-2"></Col>
        <Col lg={3} className="border-end min-vh-100 grid-line-3"></Col>
        <Col lg={4} className="border-end min-vh-100 grid-line-4"></Col>
        </Row>
      </Container> */}


      <div className="min-vh-100 position-fixed border-start z-2 grid-line-1"></div>
      <div className="min-vh-100 position-fixed border-start z-2 grid-line-2"></div>
      <div className="min-vh-100 position-fixed border-start z-2 grid-line-3"></div>
      <div className="min-vh-100 position-fixed border-start z-2 grid-line-4"></div>
    </>
  );
};
