...
const AboutDonalBanner = () => {
  ...
  return (
    <>
 <Image src="/images/D0NAL-BANER-IMG.png  " className="img-fluid w-100 h-100  " alt="..." />



       <Container className=''>
                <Row className="position-absolute start-0 bottom-0 mb-5 ms-3">
                    <Col >
      ...
      <Container className='px-4'>
        <p className=' fs-6 mx-5 mt-5'>Nestled along the picturesque coastline of Goa, Dona Paula stands as a testament to the region’s timeless allure and natural beauty. Named after Dona Paula de Menezes, a historical figure enveloped in folklore, this iconic locale captivates visitors with its panoramic vistas of the Arabian Sea and verdant landscapes.</p>
        <p className=' fs-6 mx-5 mt-5'>Renowned as the “Lover’s Paradise,” Dona Paula beckons romantics and adventurers alike to bask in its romantic ambiance and witness the breathtaking confluence of the Mandovi and Zuari rivers. The famed Dona Paula Viewpoint offers a serene retreat, where one can immerse themselves in the tranquil atmosphere and marvel at the scenic splendor that surrounds them.</p>
      </Container>
      ...
      <Container fluid className='mt-5 d-flex flex-column gap-5'>
        ...
        <Row className='mt-5'>
          ...
          <Col className='p-5 d-flex flex-column justify-content-center postion-relative' sm={12} lg={7}>
            <p className='fs-6 mb-0  p-4 me-5'>Rich in cultural heritage, Dona Paula boasts landmarks such as the Cabo Raj Bhavan, once a Portuguese fort and now the official residence of the Governor of Goa. Its vibrant markets and proximity to renowned beaches like Miramar and Vainguinim further elevate its charm, offering a perfect blend of relaxation and exploration.</p>
          </Col>
        </Row>

        <Row className=' d-flex flex-lg-row flex-column-reverse'>
          <Col className='p-5 d-flex flex-column justify-content-center ' sm={12} lg={7}>
            <p className='fs-6 mb-0 p-4 ms-5 '>With its timeless beauty, affluent ambiance, and enchanting coastal vistas, Dona Paula continues to enchant visitors and residents alike, promising an unforgettable experience amidst <p className='mb-0'></p>the wealth and luxury of Goa’s coastal paradise.</p>
          </Col>

            <Col className='p-0 ' sm={12} lg={5}>
            <Image src="/images/Donal-img4.png " className="img-fluid w-100 h-100 middle  " alt="..." />
          </Col>
        </Row>
