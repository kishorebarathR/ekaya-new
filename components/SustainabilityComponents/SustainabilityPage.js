...
const SustainabilityPage = () => {
    return (
        <>
            ...
            <Container className='mt-5 d-flex flex-column gap-5 px-lg-5  '>
                <Row className='mt-3 px-lg-4'>
                    <Col className=' ' sm={12} lg={4}>
                        <Image src="/images/Sustainability_img1.jpg" className="img-fluid w-100 h-100  " alt="..." />
                    </Col>
                    <Col className='p-lg-5 d-flex flex-column justify-content-center' sm={12} lg={8}>
                ...
                <Row className='d-flex flex-lg-row flex-column-reverse px-lg-4'>
