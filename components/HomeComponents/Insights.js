...
const Insights = () => {
    ...
    return (
        <>
            <Container className=" img-rel px-5">
                <Container className='border-top p-0'>
                    <p className='text-center  display-5'>Insights</p>
                    ...
                    <div id="demo" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <Row className='  '>
                                    ...
                                    <Col sm={4} className='p-0'>
                                        <Image src="/images/Mask Group 33.jpg" className="d-block w-100 mt-5 p-0 " alt="Third slide" />
                                        <div className='p-4 mx-3'>
                                            <p className='fs-5'>Spaces that connect inside and outside</p>
                                            <p className="mt-1">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry’s standard dummy text.</p>
                                        </div>
                            ...
                            <div class="carousel-item  ">
                                <Row className=''>
                                    ...
                                    <Col sm={4} className='p-0 '>
                                        ...
                                        <div className='p-4 mx-3'>
                                            <p classms-1Name='fs-5'>Spaces that connect inside and outside</p>
                                            <p className="mt-1">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry’s standard dummy text.</p>
                                        </div>
                                    </Col>
                                </Row>
                        ...
                        <center>
                            <button type="button" data-bs-target="#demo" data-bs-slide="prev" className='rounded-circle btn bg-white fs-4 me-2 btn-hover-slider' style={{ borderColor: "#5CA2B0" }}>
                                <FaArrowLeft className="" />
                            </button>
                            <button type="button" data-bs-target="#demo" data-bs-slide="next" className='rounded-circle btn bg-white fs-4 me-2 btn-hover-slider' style={{ borderColor: "#5CA2B0" }}>
